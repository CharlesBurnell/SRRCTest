...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/install/${idir}'.  Ask the maintainer 'cburnell <cburnell@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/install/lib;/home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/devel/lib;/opt/ros/kinetic/lib)
