...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/src/basics)
  set(basics_DEVEL_PREFIX /home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/install)
...
if(NOT "/home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/devel/include " STREQUAL " ")
  set(basics_INCLUDE_DIRS "")
  set(_include_dirs "/home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cburnell <cburnell@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/src/basics/${idir}'.  Ask the maintainer 'cburnell <cburnell@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/devel/lib;/home/cburnell/RoverSource/SRRCTest/ChuckTests/ROSTest/devel/lib;/opt/ros/kinetic/lib)
